...
public class InicioPartida extends JFrame {
	...
	public String getColorJugador1() {
		return (String) choiceColorJ1.getSelectedItem();
	}

	public String getColorJugador2() {
		return (String) choiceColorJ2.getSelectedItem();
	}

	public String getColorJugador3() {
		return (String) choiceColorJ3.getSelectedItem();
	}

	public String getColorJugador4() {
		return (String) choiceColorJ4.getSelectedItem();
	}
}
