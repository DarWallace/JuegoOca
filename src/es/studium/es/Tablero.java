...
public class Tablero extends JFrame
{
    ...
    JLabel lblCasilla1 = new JLabel("0", JLabel.CENTER);
    JLabel lblCasilla2 = new JLabel("0", JLabel.CENTER);
    JLabel lblCasilla3 = new JLabel("0", JLabel.CENTER);
    JLabel lblCasilla4 = new JLabel("0", JLabel.CENTER);
    ...
    public JButton btnTirarDados = new JButton("Tirar los dados");
    public JButton btnRehacer = new JButton("Rehacer");
    int posFicha1 = 0;
    int posFicha2 = 0;
    int posFicha3 = 0;
    int posFicha4 = 0;
    
    public Point[] posicionesCasillas = new Point[64];
 ...
 // Inicialización (llámalo en el constructor de Tablero)
    ...
    public void moverCasilla() {
    	...
    	System.out.println(posicionesCasillas[contador]);
		repaint();
    }
