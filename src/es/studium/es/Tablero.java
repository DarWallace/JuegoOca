...
public class Tablero extends JFrame {
	...
	public void avanzarTurno() {
	    ...
	    do {
	        ...
	        (turno == 1 && contadorCasillasJ1 == 63) ||
	        (turno == 2 && contadorCasillasJ2 == 63) ||
	        (turno == 3 && contadorCasillasJ3 == 63) ||
	        (turno == 4 && contadorCasillasJ4 == 63)
	...
	public void moverCasilla() {
		...
		if (jugadorTurno == 1) {
			if (!modelo.comprobarVictoria(contadorCasillasJ1)) {
			...
			if (!modelo.comprobarVictoria(contadorCasillasJ2)) {
			...
			if (!modelo.comprobarVictoria(contadorCasillasJ3)) {
			...
			if (!modelo.comprobarVictoria(contadorCasillasJ4)) {
